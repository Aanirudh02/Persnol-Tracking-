<x-app-layout title="Edit Expense">
                ...
                <div class="rounded-2xl border border-indigo-200 bg-indigo-50/70 p-4 sm:p-5 space-y-4 shadow-sm">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                        <div>
                            ...
                            <p class="text-xs text-slate-500">Track each friend's share and who paid, or remove all friends to make it an individual expense.</p>
                        </div>
    ...
    <script>
        ...
        myPaidInput.addEventListener('input', recalculateSplits);
